...
function initCursor() {
    ...
    const hoverables = document.querySelectorAll('a, button, .portfolio-card');
...
function initAnimations() {
    ...
    // 3. Section Title 亂碼效果 (Scramble Text)
