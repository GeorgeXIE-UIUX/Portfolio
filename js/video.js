...
function initCursor() {
    ...
    // 讓影片容器也有 hover 效果
    const hoverables = document.querySelectorAll('a, button, .browser-window, .iphone-mockup');
...
function initAnimations() {
    ...
    // 2. Video Items Fade Up (Batch)
    // 針對 .browser-window 和 .mockup-container 進行批次動畫
    const items = document.querySelectorAll('.browser-window, .mockup-container');
